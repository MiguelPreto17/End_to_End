...
class GeneralSettings:
	...
	bess_max_c_ch = 0.78571429  # maximum C-rate for charging [0, 1]
	bess_max_c_disch = 0.78571429   # maximum C-rate for charging [0, 1]
	...
	bess_max_c_ch2 = 0.5  # maximum C-rate for charging [0, 1]
	bess_max_c_disch2 = 0.5  # maximum C-rate for charging [0, 1]
	bess_initial_soc2 = 50.0  # SoC % at the beginning of the optimization horizon [%]
	bess_e_nom2 = 20  # nominal energy capacity [kWh]
