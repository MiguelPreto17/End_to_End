...
url = 'https://web-api.tp.entsoe.eu/api?securityToken=efb2ca19-add3-42d4-84e6-8e83986591e3&documentType=A44&in_Domain=10YPT-REN------W&out_Domain=10YPT-REN------W&periodStart=202307102300&periodEnd=202307152300'
...
if response.status_code == 200:
   # Parsear o XML
    ...
    for series in root.findall('.//{*}TimeSeries'):
        for point in series.findall('.//{*}Period'):
            ...
            for position in series.findall('.//{*}Point'):
                ...
                data['StartTime'].append(current_time)
    ...
    with open('dayahead_prices.csv', 'w', newline='') as file:
        ...
        writer.writerow(['StartTime', 'EndTime', 'Price'])
